import pandas as pd
# from views.accident_statistics_overall_view import get_accidents_overall_view, get_accidents_casualties_overall_view
from views import accident_statistics_overall_view as overall_view
from views.accident_statistics_decedents_base_view import get_accidents_decedents_base_view
# from views import accident_statistics_decedents_base_view as dec_base_view
from views.accident_statistics_decedents_team_view import get_accidents_decedents_team_view
# from views import accident_statistics_decedents_team_view as dec_team_view
from views.accident_statistics_decedents_age_cause_view import get_decedents_age_cause_view
# from views import accident_statistics_decedents_age_cause_view as dec_age_view
from views.accident_statistics_casualties_base_view import get_casualties_base_view
# from views import accident_statistics_casualties_base_view as cas_base_view
from views.accident_statistics_casualties_team_view import get_casualties_team_view
# from views import accident_statistics_casualties_team_view as cas_team_view
from views.accident_statistics_casualties_time_view import get_casualties_time_view
# from views import accident_statistics_casualties_time_view as cas_time_view
from views.accident_statistics_casualties_age_view import get_casualties_age_view
# from views import accident_statistics_casualties_age_view as cas_age_view
from views.accident_statistics_casualties_cause_view import get_casualties_cause_view
...
def generate_report(input_file):
    ...
    acc_res = get_accidents_overall_view(dataframe)
    id_res = get_accidents_casualties_overall_view(dataframe)

    dec_base_res, dec_acc_count = get_accidents_decedents_base_view(dataframe)
    ...
    cas_base_res_a, _ = get_casualties_base_view(dataframe)
    total_c_a = cas_base_res_a['一般事故'] + cas_base_res_a['简易事故']

    cas_team_df = get_casualties_team_view(dataframe)
    cas_time_table_df, cas_time_chart_df, cas_time_top3_list = get_casualties_time_view(dataframe)

    cas_age_chart_df, cas_age_top3_list = get_casualties_age_view(dataframe)

    cas_cause_top3, cas_cause_filtered_top3 = get_casualties_cause_view(dataframe)
    ...
    return wt.replace_template_variables('templates/monthly_report.docx', 'outputs/monthly_report_filled.docx', replacements, table_list, charts_list)
